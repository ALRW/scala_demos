package demos.scala.traits.onobjects
...
object Program {
  def main(args : Array[String]) {
    ...
    val toy2 = new Toy("Buzz") with Aviator { override def takeFlight() { println("To infinity and beyond!!") } }

    val penguin1 = new Penguin("Pingu")
    val penguin2 = new Penguin("Skipper") with Aviator  { override def takeFlight() { println("Lets light this candle!!") } }
